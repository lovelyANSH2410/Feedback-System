...
function handleFormSubmit(event) {
  ...
  if (userId) {
    axios
      .put(
        `https://crudcrud.com/api/83daeafa8b534c5aaf1251d5063a8691/rating/${userId}`,
        myObj
      )
      .then((response) => {
    ...
    axios
      .post(
        "https://crudcrud.com/api/83daeafa8b534c5aaf1251d5063a8691/rating",
        myObj
      )
      .then((response) => {
        console.log(response);
...
function domContentLoader() {
  ...
  axios
    .get("https://crudcrud.com/api/83daeafa8b534c5aaf1251d5063a8691/rating")
    .then((response) => {
...
function deleteUser(id) {
  axios
    .delete(
      `https://crudcrud.com/api/83daeafa8b534c5aaf1251d5063a8691/rating/${id}`
    )
    .then((response) => {
